 ...
 */
define(['exports', './defined-2a4f2d00', './Check-e5651467', './freezeObject-a51e076f', './defaultValue-29c9b1af', './Math-9620d065', './defineProperties-c817531e'], function (exports, defined, Check, freezeObject, defaultValue, _Math, defineProperties) { 'use strict';
    ...
    /**
        ...
        Cartesian3.fromSpherical = function(spherical, result) {
            ...
            var magnitude = defaultValue.defaultValue(spherical.magnitude, 1.0);
        ...
        Cartesian3.fromRadians = function(longitude, latitude, height, ellipsoid, result) {
            ...
            var radiiSquared = defined.defined(ellipsoid) ? ellipsoid.radiiSquared : wgs84RadiiSquared;
         ...
         * @constant
         */
        Cartesian3.ZERO = freezeObject.freezeObject(new Cartesian3(0.0, 0.0, 0.0));
         ...
         * @constant
         */
        Cartesian3.UNIT_X = freezeObject.freezeObject(new Cartesian3(1.0, 0.0, 0.0));
         ...
         * @constant
         */
        Cartesian3.UNIT_Y = freezeObject.freezeObject(new Cartesian3(0.0, 1.0, 0.0));
         ...
         * @constant
         */
        Cartesian3.UNIT_Z = freezeObject.freezeObject(new Cartesian3(0.0, 0.0, 1.0));
    ...
    /**
        ...
        Cartographic.fromCartesian = function(cartesian, ellipsoid, result) {
            var oneOverRadii = defined.defined(ellipsoid) ? ellipsoid.oneOverRadii : wgs84OneOverRadii;
            var oneOverRadiiSquared = defined.defined(ellipsoid) ? ellipsoid.oneOverRadiiSquared : wgs84OneOverRadiiSquared;
            var centerToleranceSquared = defined.defined(ellipsoid) ? ellipsoid._centerToleranceSquared : wgs84CenterToleranceSquared;
         ...
         * @constant
         */
        Cartographic.ZERO = freezeObject.freezeObject(new Cartographic(0.0, 0.0, 0.0));
    ...
    function initialize(ellipsoid, x, y, z) {
        ...
        defineProperties.defineProperties(Ellipsoid.prototype, {
            /**
         ...
         * @constant
         */
        Ellipsoid.WGS84 = freezeObject.freezeObject(new Ellipsoid(6378137.0, 6378137.0, 6356752.3142451793));
         ...
         * @constant
         */
        Ellipsoid.UNIT_SPHERE = freezeObject.freezeObject(new Ellipsoid(1.0, 1.0, 1.0));
         ...
         * @constant
         */
        Ellipsoid.MOON = freezeObject.freezeObject(new Ellipsoid(_Math.CesiumMath.LUNAR_RADIUS, _Math.CesiumMath.LUNAR_RADIUS, _Math.CesiumMath.LUNAR_RADIUS));
    ...
    /**
        ...
        defineProperties.defineProperties(Rectangle.prototype, {
            /**
        ...
        Rectangle.fromDegrees = function(west, south, east, north, result) {
            west = _Math.CesiumMath.toRadians(defaultValue.defaultValue(west, 0.0));
            south = _Math.CesiumMath.toRadians(defaultValue.defaultValue(south, 0.0));
            east = _Math.CesiumMath.toRadians(defaultValue.defaultValue(east, 0.0));
            north = _Math.CesiumMath.toRadians(defaultValue.defaultValue(north, 0.0));
         ...
         * @constant
        */
        Rectangle.MAX_VALUE = freezeObject.freezeObject(new Rectangle(-Math.PI, -_Math.CesiumMath.PI_OVER_TWO, Math.PI, _Math.CesiumMath.PI_OVER_TWO));
    ...
    /**
         ...
         * @constant
         */
        Cartesian2.ZERO = freezeObject.freezeObject(new Cartesian2(0.0, 0.0));
         ...
         * @constant
         */
        Cartesian2.UNIT_X = freezeObject.freezeObject(new Cartesian2(1.0, 0.0));
         ...
         * @constant
         */
        Cartesian2.UNIT_Y = freezeObject.freezeObject(new Cartesian2(0.0, 1.0));
