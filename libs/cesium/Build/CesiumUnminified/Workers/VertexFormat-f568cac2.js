 ...
 */
define(['exports', './when-0488ac89', './Check-78ca6843'], function (exports, when, Check) { 'use strict';
    ...
    /**
         ...
         */
        VertexFormat.POSITION_ONLY = when.freezeObject(new VertexFormat({
            position : true
        }));
         ...
         */
        VertexFormat.POSITION_AND_NORMAL = when.freezeObject(new VertexFormat({
            position : true,
            normal : true
        }));
         ...
         * @see VertexFormat#st
         */
        VertexFormat.POSITION_NORMAL_AND_ST = when.freezeObject(new VertexFormat({
            position : true,
            normal : true,
            st : true
        }));
         ...
         * @see VertexFormat#st
         */
        VertexFormat.POSITION_AND_ST = when.freezeObject(new VertexFormat({
            position : true,
            st : true
        }));
         ...
         */
        VertexFormat.POSITION_AND_COLOR = when.freezeObject(new VertexFormat({
            position : true,
            color : true
        }));
         ...
         */
        VertexFormat.ALL = when.freezeObject(new VertexFormat({
            position : true,
            normal : true,
            st : true,
            tangent  : true,
