 ...
 */
define(['exports', './defined-2a4f2d00', './Check-e5651467', './defaultValue-29c9b1af', './Math-9620d065', './Cartesian2-8defcb50', './Transforms-02186f8d', './ComponentDatatype-30d0acd7', './GeometryAttribute-4163fce2', './AttributeCompression-bb5cef3d', './EncodedCartesian3-323e61aa', './IndexDatatype-85d10a10', './IntersectionTests-61ae5e02', './Plane-eeb8d7d9'], function (exports, defined, Check, defaultValue, _Math, Cartesian2, Transforms, ComponentDatatype, GeometryAttribute, AttributeCompression, EncodedCartesian3, IndexDatatype, IntersectionTests, Plane) { 'use strict';
    ...
    /**
        ...
        Tipsify.calculateACMR = function(options) {
            ...
            var cacheSize = defaultValue.defaultValue(options.cacheSize, 24);
    ...
    /**
        ...
        GeometryPipeline.fitToUnsignedShortIndices = function(geometry) {
            ...
            if (defined.defined(geometry.indices) && (numberOfVertices >= _Math.CesiumMath.SIXTY_FOUR_KILOBYTES)) {
                var oldToNewIndex = [];
                var newIndices = [];
                var currentIndex = 0;
        ...
        GeometryPipeline.projectTo2D = function(geometry, attributeName, attributeName3D, attributeName2D, projection) {
            ...
            projection = (defined.defined(projection)) ? projection : new Transforms.GeographicProjection();
        ...
        GeometryPipeline.transformToWorldCoordinates = function(instance) {
            ...
            if ((defined.defined(attributes.normal)) ||
        ...
        function combineGeometries(instances, propertyName) {
            ...
            var haveIndices = (defined.defined(instances[0][propertyName].indices));
            ...
            return new GeometryAttribute.Geometry({
                ...
                boundingSphere : (defined.defined(center)) ? new Transforms.BoundingSphere(center, radius) : undefined
            });
        }
        ...
        GeometryPipeline.computeNormal = function(geometry) {
            ...
            if (!defined.defined(geometry.attributes.position) || !defined.defined(geometry.attributes.position.values)) {
        ...
        GeometryPipeline.compressVertices = function(geometry) {
            ...
            var hasNormal = defined.defined(normalAttribute);
            var hasSt = defined.defined(stAttribute);
            if (!hasNormal && !hasSt) {
                return geometry;
            }
            ...
            var hasTangent = defined.defined(tangentAttribute);
            var hasBitangent = defined.defined(bitangentAttribute);
        ...
        function updateInstanceAfterSplit(instance, westGeometry, eastGeometry) {
            var computeBoundingSphere = defined.defined(instance.geometry.boundingSphere);
        ...
        function computeTriangleAttributes(i0, i1, i2, point, positions, normals, tangents, bitangents, texCoords, extrudeDirections, applyOffset, currentAttributes, customAttributeNames, customAttributesLength, allAttributes, insertedIndex) {
            if (!defined.defined(normals) && !defined.defined(tangents) && !defined.defined(bitangents) && !defined.defined(texCoords) && !defined.defined(extrudeDirections) && customAttributesLength === 0) {
                return;
            }
        ...
        function splitLongitudeTriangles(instance) {
            ...
            var normals = (defined.defined(attributes.normal)) ? attributes.normal.values : undefined;
            var bitangents = (defined.defined(attributes.bitangent)) ? attributes.bitangent.values : undefined;
            var tangents = (defined.defined(attributes.tangent)) ? attributes.tangent.values : undefined;
            var texCoords = (defined.defined(attributes.st)) ? attributes.st.values : undefined;
            var extrudeDirections = (defined.defined(attributes.extrudeDirection)) ? attributes.extrudeDirection.values : undefined;
            var applyOffset = defined.defined(attributes.applyOffset) ? attributes.applyOffset.values : undefined;
            var indices = geometry.indices;

            var customAttributeNames = [];
            for (var attributeName in attributes) {
                if (attributes.hasOwnProperty(attributeName) && !NAMED_ATTRIBUTES[attributeName] && defined.defined(attributes[attributeName])) {
        ...
        function splitLongitudePolyline(instance) {
            ...
            var texCoords = (defined.defined(attributes.st)) ? attributes.st.values : undefined;
            var colors = (defined.defined(attributes.color)) ? attributes.color.values : undefined;
