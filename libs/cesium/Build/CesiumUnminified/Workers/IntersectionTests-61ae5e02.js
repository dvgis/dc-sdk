 ...
 */
define(['exports', './defined-2a4f2d00', './Check-e5651467', './defaultValue-29c9b1af', './Math-9620d065', './Cartesian2-8defcb50', './Transforms-02186f8d'], function (exports, defined, Check, defaultValue, _Math, Cartesian2, Transforms) { 'use strict';
    ...
    /**
        ...
        function Ray(origin, direction) {
            direction = Cartesian2.Cartesian3.clone(defaultValue.defaultValue(direction, Cartesian2.Cartesian3.ZERO));
             ...
             */
            this.origin = Cartesian2.Cartesian3.clone(defaultValue.defaultValue(origin, Cartesian2.Cartesian3.ZERO));
    ...
    /**
        ...
        IntersectionTests.lineSegmentTriangle = function(v0, v1, p0, p1, p2, cullBackFaces, result) {
            ...
            var t = IntersectionTests.rayTriangleParametric(ray, p0, p1, p2, cullBackFaces);
            if (!defined.defined(t) || t < 0.0 || t > Cartesian2.Cartesian3.distance(v0, v1)) {
                return undefined;
            }
        ...
        IntersectionTests.raySphere = function(ray, sphere, result) {
            ...
            if (!defined.defined(result) || result.stop < 0.0) {
                return undefined;
            }
        ...
        IntersectionTests.lineSegmentSphere = function(p0, p1, sphere, result) {
            ...
            result = raySphere(ray, sphere, result);
            if (!defined.defined(result) || result.stop < 0.0 || result.start > maxT) {
                return undefined;
            }
        ...
        function quadraticVectorExpression(A, b, c, x, w) {
            ...
            var l1 = w * (x * addWithCancellationCheck$1(A[Transforms.Matrix3.COLUMN1ROW0], A[Transforms.Matrix3.COLUMN0ROW1], _Math.CesiumMath.EPSILON15) + b.y);
            var l0 = (A[Transforms.Matrix3.COLUMN0ROW0] * xSquared + A[Transforms.Matrix3.COLUMN2ROW2] * wSquared) + x * b.x + c;

            var r1 = wSquared * addWithCancellationCheck$1(A[Transforms.Matrix3.COLUMN2ROW1], A[Transforms.Matrix3.COLUMN1ROW2], _Math.CesiumMath.EPSILON15);
            var r0 = w * (x * addWithCancellationCheck$1(A[Transforms.Matrix3.COLUMN2ROW0], A[Transforms.Matrix3.COLUMN0ROW2]) + b.z);
        ...
        IntersectionTests.grazingAltitudeLocation = function(ray, ellipsoid) {
            ...
            var intersects = defined.defined(this.rayEllipsoid(ray, ellipsoid));
        ...
        IntersectionTests.lineSegmentPlane = function(endPoint0, endPoint1, plane, result) {
            //>>includeStart('debug', pragmas.debug);
            if (!defined.defined(endPoint0)) {
                throw new Check.DeveloperError('endPoint0 is required.');
            }
            if (!defined.defined(endPoint1)) {
