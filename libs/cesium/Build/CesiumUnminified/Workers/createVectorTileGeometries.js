 ...
 */
define(['./when-a55a8a4c', './Check-bc1d37d9', './Math-d7cbfcf6', './Cartesian2-6ec3db89', './Transforms-a4d7073e', './RuntimeError-7c184ac0', './WebGLConstants-4c11ee5f', './ComponentDatatype-919a7463', './GeometryAttribute-291ff23b', './GeometryAttributes-1c7ce91d', './IndexDatatype-4351ba4c', './createTaskProcessorWorker', './GeometryOffsetAttribute-c9accdb9', './VertexFormat-7f136973', './BoxGeometry-f57bb5bb', './CylinderGeometryLibrary-c66635ce', './CylinderGeometry-ad81d633', './EllipsoidGeometry-f17b1f34', './Color-7baed48c'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, GeometryAttributes, IndexDatatype, createTaskProcessorWorker, GeometryOffsetAttribute, VertexFormat, BoxGeometry, CylinderGeometryLibrary, CylinderGeometry, EllipsoidGeometry, Color) { 'use strict';
    ...
    var scratchCartesian = new Cartesian2.Cartesian3();
        ...
        function boxModelMatrixAndBoundingVolume(boxes, index) {
            ...
            var boxModelMatrix = Transforms.Matrix4.unpack(boxes, boxIndex, scratchModelMatrixAndBV.modelMatrix);
        ...
        function cylinderModelMatrixAndBoundingVolume(cylinders, index) {
            ...
            var cylinderModelMatrix = Transforms.Matrix4.unpack(cylinders, cylinderIndex, scratchModelMatrixAndBV.modelMatrix);
        ...
        function ellipsoidModelMatrixAndBoundingVolume(ellipsoids, index) {
            ...
            var ellipsoidModelMatrix = Transforms.Matrix4.unpack(ellipsoids, ellipsoidIndex, scratchModelMatrixAndBV.modelMatrix);
        ...
        function sphereModelMatrixAndBoundingVolume(spheres, index) {
            ...
            var sphereModelMatrix = Transforms.Matrix4.fromTranslation(sphereTranslation, scratchModelMatrixAndBV.modelMatrix);
            Transforms.Matrix4.multiplyByUniformScale(sphereModelMatrix, sphereRadius, sphereModelMatrix);
