 ...
 */
define(['exports', './defined-2a4f2d00', './Check-e5651467', './defaultValue-29c9b1af', './Math-9620d065', './Cartesian2-8defcb50', './Transforms-02186f8d', './ComponentDatatype-30d0acd7', './GeometryAttribute-4163fce2', './GeometryAttributes-f8548d3f', './IndexDatatype-85d10a10', './GeometryOffsetAttribute-37c3dade'], function (exports, defined, Check, defaultValue, _Math, Cartesian2, Transforms, ComponentDatatype, GeometryAttribute, GeometryAttributes, IndexDatatype, GeometryOffsetAttribute) { 'use strict';
    ...
    var defaultRadii = new Cartesian2.Cartesian3(1.0, 1.0, 1.0);
        ...
        function EllipsoidOutlineGeometry(options) {
            ...
            var radii = defaultValue.defaultValue(options.radii, defaultRadii);
            var innerRadii = defaultValue.defaultValue(options.innerRadii, radii);
            var minimumClock = defaultValue.defaultValue(options.minimumClock, 0.0);
            var maximumClock = defaultValue.defaultValue(options.maximumClock, _Math.CesiumMath.TWO_PI);
            var minimumCone = defaultValue.defaultValue(options.minimumCone, 0.0);
            var maximumCone = defaultValue.defaultValue(options.maximumCone, _Math.CesiumMath.PI);
            var stackPartitions = Math.round(defaultValue.defaultValue(options.stackPartitions, 10));
            var slicePartitions = Math.round(defaultValue.defaultValue(options.slicePartitions, 8));
            var subdivisions = Math.round(defaultValue.defaultValue(options.subdivisions, 128));
        ...
        EllipsoidOutlineGeometry.createGeometry = function(ellipsoidGeometry) {
            ...
            if (defined.defined(ellipsoidGeometry._offsetAttribute)) {
