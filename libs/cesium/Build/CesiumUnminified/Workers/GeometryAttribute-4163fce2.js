 ...
 */
define(['exports', './defined-2a4f2d00', './Check-e5651467', './freezeObject-a51e076f', './defaultValue-29c9b1af', './Cartesian2-8defcb50', './defineProperties-c817531e', './Transforms-02186f8d', './WebGLConstants-90dbfe2f'], function (exports, defined, Check, freezeObject, defaultValue, Cartesian2, defineProperties, Transforms, WebGLConstants) { 'use strict';
    ...
    var GeometryType$1 = freezeObject.freezeObject(GeometryType);
    ...
    /**
         ...
         * @constant
         */
        Matrix2.IDENTITY = freezeObject.freezeObject(new Matrix2(1.0, 0.0,
                                                    0.0, 1.0));
         ...
         * @constant
         */
        Matrix2.ZERO = freezeObject.freezeObject(new Matrix2(0.0, 0.0,
                                                0.0, 0.0));
        ...
        defineProperties.defineProperties(Matrix2.prototype, {
            /**
    ...
    var PrimitiveType$1 = freezeObject.freezeObject(PrimitiveType);
    ...
    /**
        ...
        function Geometry(options) {
             ...
             * @default undefined
             */
            this.primitiveType = defaultValue.defaultValue(options.primitiveType, PrimitiveType$1.TRIANGLES);
        ...
        Geometry.computeNumberOfVertices = function(geometry) {
            ...
            for ( var property in geometry.attributes) {
                if (geometry.attributes.hasOwnProperty(property) &&
                        defined.defined(geometry.attributes[property]) &&
                        defined.defined(geometry.attributes[property].values)) {
    ...
    /**
        ...
        function GeometryAttribute(options) {
            ...
            if (!defined.defined(options.values)) {
