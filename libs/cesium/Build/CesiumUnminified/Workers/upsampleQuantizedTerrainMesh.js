...
define(['./when-c2e8ef35', './Check-c4f3a3fc', './Math-a06249ed', './Cartesian2-a4e73c05', './Transforms-533d1994', './RuntimeError-6122571f', './WebGLConstants-4ae0db90', './ComponentDatatype-762ab5b7', './AttributeCompression-6b12d004', './IndexDatatype-755cb3fd', './IntersectionTests-11682642', './Plane-beebe18b', './createTaskProcessorWorker', './EllipsoidTangentPlane-cf837d4c', './OrientedBoundingBox-85824f79', './TerrainEncoding-92206ecb'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, AttributeCompression, IndexDatatype, IntersectionTests, Plane, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, TerrainEncoding) { 'use strict';
    ...
    var maxShort = 32767;
        ...
        function upsampleQuantizedTerrainMesh(parameters, transferableObjects) {
            ...
            var boundingSphere = Transforms.BoundingSphere.fromVertices(cartesianVertices, Cartesian2.Cartesian3.ZERO, 3, boundingSphereScratch);
