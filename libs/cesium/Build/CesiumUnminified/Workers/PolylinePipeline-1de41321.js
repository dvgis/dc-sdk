 ...
 */
define(['exports', './defined-2a4f2d00', './Check-e5651467', './defaultValue-29c9b1af', './Math-9620d065', './Cartesian2-8defcb50', './Transforms-02186f8d', './IntersectionTests-61ae5e02', './Plane-eeb8d7d9', './EllipsoidRhumbLine-1d34a7ab', './EllipsoidGeodesic-1758a5f7'], function (exports, defined, Check, defaultValue, _Math, Cartesian2, Transforms, IntersectionTests, Plane, EllipsoidRhumbLine, EllipsoidGeodesic) { 'use strict';
    ...
    /**
        ...
        PolylinePipeline.wrapLongitude = function(positions, modelMatrix) {
            ...
            if (defined.defined(positions) && positions.length > 0) {
                modelMatrix = defaultValue.defaultValue(modelMatrix, Transforms.Matrix4.IDENTITY);
        ...
        PolylinePipeline.generateArc = function(options) {
            ...
            var height = defaultValue.defaultValue(options.height, 0);
            var hasHeightArray = Transforms.isArray(height);
