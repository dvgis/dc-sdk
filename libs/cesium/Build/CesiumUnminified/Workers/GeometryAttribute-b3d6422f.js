 ...
 */
define(['exports', './when-0488ac89', './Check-78ca6843', './Cartesian2-e22df635', './defineProperties-c6a70625', './Transforms-2f1d88cd', './WebGLConstants-66e14a3b'], function (exports, when, Check, Cartesian2, defineProperties, Transforms, WebGLConstants) { 'use strict';
    ...
    var GeometryType$1 = when.freezeObject(GeometryType);
    ...
    /**
         ...
         * @constant
         */
        Matrix2.IDENTITY = when.freezeObject(new Matrix2(1.0, 0.0,
                                                    0.0, 1.0));
         ...
         * @constant
         */
        Matrix2.ZERO = when.freezeObject(new Matrix2(0.0, 0.0,
                                                0.0, 0.0));
    ...
    var PrimitiveType$1 = when.freezeObject(PrimitiveType);
