 ...
 */
define(['exports', './defined-2a4f2d00', './Check-e5651467', './defaultValue-29c9b1af', './Cartesian2-8defcb50', './Transforms-02186f8d', './ComponentDatatype-30d0acd7', './GeometryAttribute-4163fce2', './GeometryAttributes-f8548d3f', './GeometryOffsetAttribute-37c3dade', './VertexFormat-ba88c609'], function (exports, defined, Check, defaultValue, Cartesian2, Transforms, ComponentDatatype, GeometryAttribute, GeometryAttributes, GeometryOffsetAttribute, VertexFormat) { 'use strict';
    ...
    var diffScratch = new Cartesian2.Cartesian3();
        ...
        BoxGeometry.pack = function(value, array, startingIndex) {
            ...
            array[startingIndex + 2 * Cartesian2.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength] = defaultValue.defaultValue(value._offsetAttribute, -1);
        ...
        BoxGeometry.getUnitBox = function() {
            if (!defined.defined(unitBoxGeometry)) {
