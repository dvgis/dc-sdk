 ...
 */
define(['exports', './defined-2a4f2d00', './Check-e5651467', './freezeObject-a51e076f', './defaultValue-29c9b1af', './Math-9620d065', './Cartesian2-8defcb50', './defineProperties-c817531e', './Transforms-02186f8d', './ComponentDatatype-30d0acd7', './AttributeCompression-bb5cef3d'], function (exports, defined, Check, freezeObject, defaultValue, _Math, Cartesian2, defineProperties, Transforms, ComponentDatatype, AttributeCompression) { 'use strict';
    ...
    /**
        ...
        function EllipsoidalOccluder(ellipsoid, cameraPosition) {
            ...
            if (defined.defined(cameraPosition)) {
        ...
        EllipsoidalOccluder.prototype.isScaledSpacePointVisiblePossiblyUnderEllipsoid = function(occludeeScaledSpacePosition, minimumHeight) {
            ...
            if (defined.defined(minimumHeight) && minimumHeight < 0.0 && ellipsoid.minimumRadius > -minimumHeight) {
    ...
    var TerrainQuantization$1 = freezeObject.freezeObject(TerrainQuantization);
    ...
    var cartesian3Scratch = new Cartesian2.Cartesian3();
        ...
        function TerrainEncoding(axisAlignedBoundingBox, minimumHeight, maximumHeight, fromENU, hasVertexNormals, hasWebMercatorT) {
            ...
            if (defined.defined(axisAlignedBoundingBox) && defined.defined(minimumHeight) && defined.defined(maximumHeight) && defined.defined(fromENU)) {
