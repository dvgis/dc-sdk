 ...
 */
define(['exports', './defined-2a4f2d00', './Check-e5651467', './defaultValue-29c9b1af', './Math-9620d065', './Cartesian2-8defcb50', './Transforms-02186f8d', './ComponentDatatype-30d0acd7', './GeometryAttribute-4163fce2', './GeometryAttributes-f8548d3f', './IndexDatatype-85d10a10', './GeometryOffsetAttribute-37c3dade', './VertexFormat-ba88c609'], function (exports, defined, Check, defaultValue, _Math, Cartesian2, Transforms, ComponentDatatype, GeometryAttribute, GeometryAttributes, IndexDatatype, GeometryOffsetAttribute, VertexFormat) { 'use strict';
    ...
    var scratchPosition = new Cartesian2.Cartesian3();
        ...
        function EllipsoidGeometry(options) {
            ...
            var stackPartitions = Math.round(defaultValue.defaultValue(options.stackPartitions, 64));
            var slicePartitions = Math.round(defaultValue.defaultValue(options.slicePartitions, 64));
        ...
        EllipsoidGeometry.getUnitEllipsoid = function() {
            if (!defined.defined(unitEllipsoidGeometry)) {
