 ...
 */
define(['exports', './defined-2a4f2d00', './Check-e5651467', './freezeObject-a51e076f', './defaultValue-29c9b1af'], function (exports, defined, Check, freezeObject, defaultValue) { 'use strict';
    ...
    /**
         ...
         */
        VertexFormat.POSITION_ONLY = freezeObject.freezeObject(new VertexFormat({
            position : true
        }));
         ...
         */
        VertexFormat.POSITION_AND_NORMAL = freezeObject.freezeObject(new VertexFormat({
            position : true,
            normal : true
        }));
         ...
         * @see VertexFormat#st
         */
        VertexFormat.POSITION_NORMAL_AND_ST = freezeObject.freezeObject(new VertexFormat({
            position : true,
            normal : true,
            st : true
        }));
         ...
         * @see VertexFormat#st
         */
        VertexFormat.POSITION_AND_ST = freezeObject.freezeObject(new VertexFormat({
            position : true,
            st : true
        }));
         ...
         */
        VertexFormat.POSITION_AND_COLOR = freezeObject.freezeObject(new VertexFormat({
            position : true,
            color : true
        }));
         ...
         */
        VertexFormat.ALL = freezeObject.freezeObject(new VertexFormat({
            position : true,
            normal : true,
            st : true,
            tangent  : true,
        ...
        VertexFormat.clone = function(vertexFormat, result) {
            if (!defined.defined(vertexFormat)) {
                return undefined;
            }
            if (!defined.defined(result)) {
                result = new VertexFormat();
