...
define(['exports', './defined-26bd4a03', './Check-da037458', './defaultValue-f2e68450', './Math-fa6e45cb', './Cartesian2-2a723276', './defineProperties-6f7a50f2'], function (exports, defined, Check, defaultValue, _Math, Cartesian2, defineProperties) { 'use strict';
    ...
    function calculateM(ellipticity, major, latitude) {
        ...
        function EllipsoidRhumbLine(start, end, ellipsoid) {
            var e = defaultValue.defaultValue(ellipsoid, Cartesian2.Ellipsoid.WGS84);
            this._ellipsoid = e;
            ...
            if (defined.defined(start) && defined.defined(end)) {
                computeProperties(this, start, end, e);
            }
        }

        defineProperties.defineProperties(EllipsoidRhumbLine.prototype, {
            /**
             * Gets the ellipsoid.
        ...
        EllipsoidRhumbLine.fromStartHeadingDistance = function(start, heading, distance, ellipsoid, result) {
            ...
            if (!defined.defined(result) || (defined.defined(ellipsoid) && !ellipsoid.equals(result.ellipsoid))) {
        ...
        EllipsoidRhumbLine.prototype.interpolateUsingSurfaceDistance = function(distance, result) {
            ...
            if (!defined.defined(this._distance) || this._distance === 0.0) {
