...
define(['exports', './when-76089d4c', './Check-5cd4f88e', './Math-4da9b357', './defineProperties-7057a760'], function (exports, when, Check, _Math, defineProperties) { 'use strict';
    ...
    /**
         ...
         * @constant
         */
        Cartesian3.ZERO = when.freezeObject(new Cartesian3(0.0, 0.0, 0.0));
         ...
         * @constant
         */
        Cartesian3.UNIT_X = when.freezeObject(new Cartesian3(1.0, 0.0, 0.0));
         ...
         * @constant
         */
        Cartesian3.UNIT_Y = when.freezeObject(new Cartesian3(0.0, 1.0, 0.0));
         ...
         * @constant
         */
        Cartesian3.UNIT_Z = when.freezeObject(new Cartesian3(0.0, 0.0, 1.0));
    ...
    /**
         ...
         * @constant
         */
        Cartographic.ZERO = when.freezeObject(new Cartographic(0.0, 0.0, 0.0));
    ...
    function initialize(ellipsoid, x, y, z) {
         ...
         * @constant
         */
        Ellipsoid.WGS84 = when.freezeObject(new Ellipsoid(6378137.0, 6378137.0, 6356752.3142451793));
         ...
         * @constant
         */
        Ellipsoid.UNIT_SPHERE = when.freezeObject(new Ellipsoid(1.0, 1.0, 1.0));
         ...
         * @constant
         */
        Ellipsoid.MOON = when.freezeObject(new Ellipsoid(_Math.CesiumMath.LUNAR_RADIUS, _Math.CesiumMath.LUNAR_RADIUS, _Math.CesiumMath.LUNAR_RADIUS));
    ...
    /**
         ...
         * @constant
        */
        Rectangle.MAX_VALUE = when.freezeObject(new Rectangle(-Math.PI, -_Math.CesiumMath.PI_OVER_TWO, Math.PI, _Math.CesiumMath.PI_OVER_TWO));
    ...
    /**
         ...
         * @constant
         */
        Cartesian2.ZERO = when.freezeObject(new Cartesian2(0.0, 0.0));
         ...
         * @constant
         */
        Cartesian2.UNIT_X = when.freezeObject(new Cartesian2(1.0, 0.0));
         ...
         * @constant
         */
        Cartesian2.UNIT_Y = when.freezeObject(new Cartesian2(0.0, 1.0));
