...
define(['exports', './when-ef0df1c5', './Math-9bc506ad', './Cartesian2-e248b6a8', './EllipsoidTangentPlane-48f30934', './PolygonPipeline-11409718', './PolylinePipeline-b9c8f88b'], function (exports, when, _Math, Cartesian2, EllipsoidTangentPlane, PolygonPipeline, PolylinePipeline) { 'use strict';
  ...
  function latLonEquals(c0, c1) {
    return (
      _Math.CesiumMath.equalsEpsilon(c0.latitude, c1.latitude, _Math.CesiumMath.EPSILON14) &&
      _Math.CesiumMath.equalsEpsilon(c0.longitude, c1.longitude, _Math.CesiumMath.EPSILON14)
    );
  }
